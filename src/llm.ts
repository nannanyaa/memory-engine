 ...
 *
 * 情感识别经拍板用模型（LLM 分类，不设规则闸门）。为避免引入整包依赖，
...
/** 13 种情绪维度（已定稿，一字不改）。复合主导维度另含 感动/守护/其它。 */
...
- 普通请求、提问、技术话题、工作汇报、闲聊、寒暄、事务性对话一律不算情感节点（如"帮我查一下/这个怎么用/改好了吗/收到"）。
- 只有涉及对方个体、关系、承诺、依赖、想念、守护、直接表白/感受的直接情感表达才算情感节点。
- 拿不准时一律判 false（宁漏不误存）。
